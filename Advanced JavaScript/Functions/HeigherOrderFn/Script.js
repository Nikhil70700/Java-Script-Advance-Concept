...
// console.log(greetFunction("Nikhil"));
...
const add=(a,b)=>{  //Call Back Function because it is passed in another function as an argument
    return a+b;
...
console.log(mathOperation(5,5,add));  //Higher Order Function Because it takes another function as an argument.
console.log(mathOperation(15,10,sub));